            ...
            for i_3 in xrange(len(N_list)): 
                ...
                while num_seed < MAXSEED:
                    ...
                    while index < MAXITER:
                        ...
                        time_accumulate.append(time.clock()-start_all)
                        ...
                        with h5.File(filename,'w') as f:
                            ...
                            f.create_dataset('time_iter', data=time_iteration)
                            f.create_dataset('time_acc', data=time_accumulate)
